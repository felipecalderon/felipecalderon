...
<h4 align="center">Desarollador autónomo en el universo Javascript con Typescript, amo las nuevas tecnologías que han surgido en torno a JS, Frameworks como NextJS (fullstack), NestJs (backend), Stacks PERN, MERN, bases de datos y ORM como Sequelize, Prisma y Firebase, un basto universo que jamás terminaré de aprender, pero full motivado por entender cada vez mejor su funcionamiento.</h4>
</div>
